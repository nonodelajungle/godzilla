...
export const FAMILY_TEMPLATES: Record<ProductFamily, FamilyTemplate> = {
  ...
  team_workspace: {
    ...
    trustSignals: [
      "workspace_presence",
      "activity_state",
      "shared_docs_or_context",
      "permissions",
    ],
    retentionLoop: [
      "notifications",
      "daily_active_channels",
      "task_updates",
      "ai_summaries",
    ],
    opsSurface: [
